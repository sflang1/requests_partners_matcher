...
def seed_partners
  ...
  100.times.each do
    ActiveRecord::Base.transaction do
      ...
      price  = Random.rand(15.0..50.0).round(2)

      partner = Partner.create(name: Faker::Company.unique.name, lat: lat, lng: lng, operating_radius: operating_radius, rating: rating, price: price)
